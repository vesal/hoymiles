...
class MISeriesMicroinverterData(Structure):
    ...
    port_number: int = member(fmt=uint16, doc='Port number.')
    ...
    link_status: int = member(fmt=uint16, doc='Link status.')
    reserved1: int = member(fmt=uint16, doc='Reserved1.')
    reserved2: int = member(fmt=uint16, doc='Reserved2.')
    reserved3: int = member(fmt=uint16, doc='Reserved3.')
    reserved4: int = member(fmt=uint16, doc='Reserved4.')
    reserved5: int = member(fmt=uint16, doc='Reserved5.')
    reserved6: int = member(fmt=uint16, doc='Reserved6.')
    reserved7: int = member(fmt=uint16, doc='Reserved7.')
    data_type: int = member(fmt=uint16, doc='Data type.')
